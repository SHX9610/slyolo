import numpy as np
anchor = open('F:\Projects\yolov3\sl-master\data131_v1\\anchor_12.txt') #原始anchors
expand_anchor = open('F:\Projects\yolov3\sl-master\data131_v1\\anchor_12_new.txt','w')  #变换后的anchor保存地址
ratio=0.5   #最小的锚框缩小倍数
